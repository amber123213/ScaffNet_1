...
args.add_argument('--config_filename', default=CONFIG_FILE, type=str)
...
# 根据配置文件设置模型名称
if 'model' in config and 'model_name' in config['model']:
...
args.add_argument('--lambda_guidance', default=config['train']['lambda_guidance'], type=float)
